...
public class FamilyMember extends BaseEntity {
    ...
    // Override toString: Avoid printing full child and parent objects to prevent recursion
    @Override
    public String toString() {
        return "FamilyMember{" +
                ...
                ", parent=" + (parent != null ? parent.getId() : "null") +  // Print parent ID to avoid recursion
                '}';
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!super.equals(o)) return false;  // Call BaseEntity's equals

        FamilyMember that = (FamilyMember) o;
        return Objects.equals(relationship, that.relationship) &&
                Objects.equals(person, that.person) &&
                Objects.equals(parent, that.parent);  // Compare parent by ID
    }

    // Override hashCode
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), relationship, person, parent);  // Include BaseEntity's hashCode
    }
}
