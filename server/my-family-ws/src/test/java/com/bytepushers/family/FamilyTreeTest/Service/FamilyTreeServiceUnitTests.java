...
public class FamilyTreeServiceUnitTests {
    ...
    public void saveFamilyTreeTest(){
        ...
        //action
        FamilyTree savedFamilyTree = familyTreeService.saveFamilyTree(familyTree);
    ...
    public void getFamilyTreeById(){
        ...
        // action
        FamilyTree existingFamilytree = familyTreeService.getFamilyTreeById(familyTree.getId()).get();
