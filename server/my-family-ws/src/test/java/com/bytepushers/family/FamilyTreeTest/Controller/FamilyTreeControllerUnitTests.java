...
//import com.bytepushers.family.familyTree.Controller.FamilyTreeController;
...
//        given(familyTreeService.getAllFamily()).willReturn(familyTreeList);
//
//        // action
...
//        given(familyTreeService.updateFamilyTree(any(Long.class), any(FamilyTree.class))).willReturn(familyTree);
//
//        // action
