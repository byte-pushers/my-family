...
export const errorMessagesMap = new Map<string, string>([
  ...
  ['E008', `${0} is required, please fill out ${0} input field`],
  ...
  ['E012', `${0} cannot contain a negative value`],
  ['E013', `${0} can not be more than 140, Please check age`],
  ['E014', `${0} must be at least 8 characters long`],
  ['E015', `Please enter valid ${0} address, (e.g., name@example.com`],
  ['E016', 'Network timeout. Please check your internet connection'],
